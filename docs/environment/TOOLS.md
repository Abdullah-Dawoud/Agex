...
- Setup repository: project auto-configuration succeeded, but PowerShell language-server health check failed because Serena could not write/install `PSScriptAnalyzer 1.25.0` under `%USERPROFILE%\.serena`. No ACL workaround was attempted.

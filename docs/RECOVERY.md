...
Latest known backup: `C:\Users\isc\AppData\Local\AI-Developer-Setup\backups\20260920-024012`. It contains `config.toml` and `.gitconfig` only. Keep this path outside Git.

Serena removal backup: `C:\Users\isc\AppData\Local\AI-Developer-Setup\backups\serena-removal-20260920-224545`. Do not restore it during normal recovery.
